...
return '👨🏻‍💻│ اصدار سورس MOON  : *v'..version..'* \n📡'
end
...
sendMsg(msg.chat_id_,msg.id_,'📛*│* عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس MOON يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n💥')
end  
else
...
if MsgText[1]== "مجموعة المتجر 📡" and msg.type == "pv" then
local inline = {{{text="⚜│ مجموعة المتجر ضـغـط هنا ",url="https://t.me/iMoonstore"}}}
send_key(msg.sender_user_id_,'  [🌙│مجموعة المتجر](https://t.me/iMoonstore)',nil,inline,msg.id_)
return false
end
...
👨🏻‍💻│اهلا بك في سورس MOON ❤️

🧔🏻|[مطور الـسـورس](https://t.me/pppn6)
📨│ [قروب المتجر](https://t.me/iMoonstore) 
...
local rfih = (redis:get(max..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
if rfih == 0 then  return "⚠️*│*عذرا لا يوجد تعديلات لك في البوت  ✖️" end
redis:del(max..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
return "♦️*│*تم مسح {* "..rfih.." *} من تعديلاتك ☔️\n✓"
end
...
return sendMsg(msg.chat_id_,msg.id_,lovm[math.random(#lovm)])
elseif Text== "تف" then return sendMsg(msg.chat_id_,msg.id_,"تف ع وجهك البيض.")
